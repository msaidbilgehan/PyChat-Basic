...
print("Paths initialized:", DIR_ROOT, DIR_FOLDER_TEMPLATE, DIR_FOLDER_STATIC, DIR_FOLDER_WORKING, DIR_FOLDER_DB, DIR_FOLDER_PUBLIC_FILES, DIR_FOLDER_LOGS, DIR_FILE_LOGS_GENERAL, DIR_FILE_DB)